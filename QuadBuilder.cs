...
{
    public static int res = 10; // The resolution of the quads (24)
    ...
    public static void GenerateQuadTemplate()
    {
        ...
        for (int quadI = 0; quadI < 16; quadI++)
        {
            ...
            for (int y = 0; y < (res + 1); y++)
            {
                ...
                {
                    Vector3 pos = new Vector3(x - res * 0.5f, y - res * 0.5f, 0) / (res / 2);

                    // Border vertices
                    selectedQuadTemplateVertices[y * (res + 1) + x] = pos;
                    if (x == 0 && y == 0)
                    {
                        selectedQuadTemplateBorderVertices[borderVertexOffset] = pos + new Vector3(-(2f + 2 * (quadI & 2) * 0.5f) / res, -(2f + 2 * (quadI & 4) * 0.25f) / res, 0);
                        selectedQuadTemplateBorderVertices[borderVertexOffset + res + 3] = pos + new Vector3(-(2f + 2 * (quadI & 2) * 0.5f) / res, 0, 0);
                        borderVertexOffset++;
                    }

                    if (y == 0)
                    {
                        selectedQuadTemplateBorderVertices[borderVertexOffset] = pos + new Vector3(0, -(2f + 2 * (quadI & 4) * 0.25f) / res, 0);
                        borderVertexOffset++;
                    }

                    if (x == res && y == 0)
                    {
                        selectedQuadTemplateBorderVertices[borderVertexOffset] = pos + new Vector3((2f + 2 * (quadI & 1)) / res, -(2f + 2 * (quadI & 4) * 0.25f) / res, 0);
                        borderVertexOffset += 2;
                    }

                    if (x == 0 && y != 0)
                    {
                        selectedQuadTemplateBorderVertices[borderVertexOffset] = pos + new Vector3(-(2f + 2 * (quadI & 2) * 0.5f) / res, 0, 0);
                        borderVertexOffset++;
                    }

                    if (x == res && y != res)
                    {
                        selectedQuadTemplateBorderVertices[borderVertexOffset] = pos + new Vector3((2f + 2 * (quadI & 1)) / res, 0, 0);
                        borderVertexOffset++;
                    }

                    if (x == 0 && y == res)
                    {
                        selectedQuadTemplateBorderVertices[borderVertexOffset + 1] = pos + new Vector3(-(2f + 2 * (quadI & 2) * 0.5f) / res, (2f + 2 * (quadI & 8) * 0.125f) / res, 0);
                        borderVertexOffset += 2;
                    }

                    if (y == res)
                    {
                        selectedQuadTemplateBorderVertices[borderVertexOffset] = pos + new Vector3(0, (2f + 2 * (quadI & 8) * 0.125f) / res, 0);
                        borderVertexOffset++;
                    }

                    if (x == res && y == res)
                    {
                        selectedQuadTemplateBorderVertices[borderVertexOffset] = pos + new Vector3((2f + 2 * (quadI & 1)) / res, (2f + 2 * (quadI & 8) * 0.125f) / res, 0);
                        selectedQuadTemplateBorderVertices[borderVertexOffset - res - 3] = pos + new Vector3((2f + 2 * (quadI & 1)) / res, 0, 0);
                        borderVertexOffset++;
                    }
                }
            }
